...
function showEditForm(index) {
  ...
  saveBtn.onclick = () => {
    ...
    topic.anonymous = anonCheckbox.checked;  // 同步匿名設定
    setData("vote_users", users);
    renderTopics();
  };
